                            ...
                            <div class="col">
                                <div class="card" style="width: 22rem">
                                    <a href="detail-pengumuman.php?id=<?= $pengumuman['id']; ?>" style="text-decoration: none;color: #000;">
                                        <img src="assets/img/result.jpg" class="card-img-top" alt="card" height="200px"/>
        ...
        <section class="pelayanan">
            <div class="container">
                <center>
                        ...
                        <div class="col-8">
                            <div class="description">
                                ...
                                <div class="text-description">
                                    ...
                                    <a href="tes.php" target="_blank" class="btn btn-primary">Daftar</a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                        ...
                        <div class="col-8">
                            <div class="description">
                                ...
                                <div class="text-description">
                                    ...
                                    <a href="kursus.php" target="_blank" class="btn btn-primary">Daftar</a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                        ...
                        <div class="col-8">
                            <div class="description">
                                ...
                                <div class="text-description">
                                    ...
                                    <a href="sertif.php" target="_blank" class="btn btn-primary">Ajukan</a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                    ...
                    <div class="btn-pelayanan">
                    <?php $ambil=$koneksi->query("SELECT * FROM linktree WHERE terbit='Ya'"); ?>
                    <?php while($linktree=$ambil->fetch_assoc()) { ?>
                        <a class="btn btn-outline-danger btn-pelayanan" target="_blank" href="<?= $linktree['link']; ?>"><?=$linktree['nama']; ?></a>
                    <?php } ?>
                    </center>
                </div>
            </div>
